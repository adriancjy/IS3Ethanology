	...
	var awUrl = "http://localhost/AWD.gpx";
	var masterUrl = "http://localhost/Master.gpx";
	var ddUrl = "http://localhost/DrinkingAndDancing.gpx";
	var edUrl = "http://localhost/EatingAndDrinking.gpx";
	var lmUrl = "http://localhost/LiveMusic.gpx";
	var sbUrl = "http://localhost/SportsBar.gpx";
	var cUrl = "http://localhost/ChillingWithMates.gpx";
	var globalUrl;
